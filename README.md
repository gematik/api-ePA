...
<code><pre>
api-epa
|- [docs](HEAD/docs) (additional information)
|- [images](HEAD/images) (images of this page)
|- [samples](HEAD/samples) (samples)
|     |-- [epa 1 messages PS - Konnektor](HEAD/samples/ePA%201%20Beispielnachrichten%20PS%20-%20Konnektor)
|     |-- [epa 2 messages PS - Konnektor](HEAD/samples/ePA%202%20Beispielnachrichten%20PS%20-%20Konnektor)
|     └-- [policies](HEAD/samples/policies) (Policy Beispiele)
|- [src](HEAD/src) (normative resources)
|     |-- [implementation_guides](HEAD/src/implementation_guides) (metadata for structured documents)
|     |-- [openapi](HEAD/src/openapi) (interfaces REST)
|     |-- [policies](HEAD/src/policies) (policy templates)
|     |-- [schema](HEAD/src/schema) (interfaces SOAP)
|     |     |-- [tel](HEAD/src/schema/tel) (telematik error scheme)
|     |     |-- [ext](HEAD/src/schema/ext) (external schemes)
|     |     └-- [fd/phr](HEAD/src/schema/fd/phr) (interface ePA health record system)
|     └-- [vocabulary](HEAD/src/vocabulary) (terminologies)
|- [README.md](HEAD/README.md) (this information)
|- [ReleaseNotes.md](HEAD/ReleaseNotes.md) (release history)
|- [Branchinformation](HEAD/Branchinformation.md) (information about branch status and links)
|- [LICENSE](HEAD//LICENSE) (license file)
└- [SECURITY.md](HEAD/SECURITY.md) (security policy)
</pre>
</code>
